...
/*
 * This function will be called when we open teh device file
 */
static int etx_open(struct inode *inode, struct file *file) {
...
static ssize_t etx_write(struct file *filp, const char __user *buf, size_t len, loff_t *off) {
	// Copy the data to kernel spaced from the user-space
...
MODULE_DESCRIPTION("Simple Linux device");
MODULE_VERSION("1.0");	
